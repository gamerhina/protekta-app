...
class SuratStatusUpdatedNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $subject = 'Status Surat Diperbarui: ' . $statusText . ' - ' . ($this->surat->jenis->nama ?? 'N/A');
        ...
        $mailMessage = (new MailMessage)
            ->subject($subject)
            ->greeting($greeting)
            ->line('Status permohonan surat Anda telah diperbarui.')
            ->line('**Detail Surat:**')
        ...
        } elseif ($this->surat->status === 'dikirim') {
            $mailMessage->line('Surat Anda telah selesai diproses dan dapat diunduh.');
        }
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            ...
            'status_text' => $statusMessages[$this->surat->status] ?? $this->surat->status,
            'message' => 'Status surat diperbarui: ' . ($statusMessages[$this->surat->status] ?? $this->surat->status),
