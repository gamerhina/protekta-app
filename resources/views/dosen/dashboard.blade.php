...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="py-4 md:py-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4 mb-6">
            ...
            <div class="relative overflow-hidden rounded-2xl bg-white/70 shadow-md border border-slate-200/70 backdrop-blur-md">
                <div class="absolute -right-4 -top-4 opacity-10 text-6xl text-blue-500">
                    <i class="fas fa-bullseye"></i>
                </div>
                <div class="px-4 py-3 md:px-4 md:py-3 flex flex-col justify-between h-full">
                    <div>
                        <p class="text-xs font-semibold uppercase tracking-[0.15em] text-slate-400">Ringkasan</p>
                        <p class="mt-2 text-sm text-slate-600 leading-relaxed">
                            Fokus pada tugas evaluasi yang belum selesai dan pantau progres seminar bimbingan Anda dari satu halaman.
                        </p>
                    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-6 mb-8">
            ...
            <a href="{{ route('dosen.mahasiswa.index') }}" class="group relative overflow-hidden rounded-2xl border border-purple-100/70 bg-gradient-to-br from-purple-50/80 to-fuchsia-50/80 p-4 md:p-5 shadow-sm hover:shadow-md hover:-translate-y-0.5 backdrop-blur-md transition">
                <div class="absolute -right-4 -top-4 h-20 w-20 rounded-full bg-purple-500/10 group-hover:bg-purple-500/20 transition"></div>
                <div class="relative flex items-start gap-3">
                    <div class="inline-flex items-center justify-center w-9 h-9 rounded-2xl bg-purple-500/90 text-white shadow-md backdrop-blur-md">
                        <i class="fas fa-user-graduate"></i>
                    </div>
                    <div class="flex-1 bg-white/60 md:bg-transparent rounded-xl md:rounded-none px-3 py-2 md:px-0 md:py-0 backdrop-blur-md md:backdrop-blur-0">
                        <h3 class="text-sm md:text-base font-semibold text-slate-900">Profil Mahasiswa</h3>
                        <p class="mt-1 text-xs md:text-sm text-slate-500">Akses cepat ke data kontak dan informasi mahasiswa bimbingan.</p>
                        <div class="mt-3 inline-flex items-center text-xs font-semibold text-purple-700 group-hover:translate-x-1 transition bg-purple-50/70 md:bg-transparent px-3 py-1 rounded-full md:px-0 md:py-0 md:rounded-none backdrop-blur-md md:backdrop-blur-0">
                            Lihat daftar
                            <i class="fas fa-arrow-right ml-2"></i>
                        </div>
                    </div>
