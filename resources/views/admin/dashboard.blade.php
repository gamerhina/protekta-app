    ...
    <div class="grid gap-6 lg:grid-cols-3">
        ...
        <div class="bg-white rounded-3xl border border-gray-100 shadow-lg p-6">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-gray-600">Template Dokumen</p>
                        <p class="font-semibold text-gray-900">{{ $templateCount }} file siap pakai</p>
                    </div>
                    <span class="px-3 py-1 rounded-full text-xs font-semibold bg-blue-50 text-blue-600">Sistem Ready</span>
                </div>
                <div>
