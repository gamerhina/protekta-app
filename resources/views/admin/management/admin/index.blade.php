                ...
                <div class="grid gap-4 md:grid-cols-[1fr_auto]">
                    <div>
                        ...
                        <div class="relative mt-1">
                            ...
                            <input type="text" name="search" id="search" value="{{ request('search') }}" placeholder="Nama, NIP, email, atau kontak"
                    ...
                    <div class="flex items-end gap-3">
                        ...
                        <a href="{{ route('admin.admins.index') }}" class="px-6 py-2.5 rounded-xl text-sm font-semibold text-gray-600 bg-gray-100 hover:bg-gray-200 transition">
                            Reset
                        </a>
                    </div>
                </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead>
                    <tr>
                        ...
                        <x-sortable-th column="hp" label="Phone" :default-sort="$defaultSort" :default-direction="$defaultDirection" />
