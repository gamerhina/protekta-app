...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="py-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
            ...
            <p class="text-gray-600">Welcome back, <strong>{{ auth()->user() ? (auth()->user()->nama ?? auth()->user()->name) : 'Mahasiswa' }}</strong>!</p>
            <p class="text-gray-600">NPM: {{ auth()->user() ? (auth()->user()->npm ?? 'N/A') : 'N/A' }}</p>
