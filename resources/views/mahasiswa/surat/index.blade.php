...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-2xl font-semibold text-gray-800">Riwayat Permohonan Surat</h1>
                            ...
                            <td class="px-6 py-4 text-sm text-center">
                                <div class="flex items-center justify-center gap-3">
                                    ...
                                    @if(in_array($s->status, ['diproses', 'dikirim']) && ($s->jenis->allow_download ?? true))
                                        <a href="{{ route('mahasiswa.surat.download', $s) }}" class="text-green-600 hover:text-green-800 transition-colors" title="Unduh Surat" download data-no-ajax>
